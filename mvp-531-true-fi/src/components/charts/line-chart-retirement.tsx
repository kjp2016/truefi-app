...
import { tailwindConfig, formatValue } from '@/lib/utils';
import { chartColors } from './chartjs-config';
import { useTheme } from 'next-themes';

Chart.register(LineController, LineElement, Filler, PointElement, LinearScale, TimeScale, Tooltip);

export const LineChartRetirement = ({
  data,
  width,
  height
        ...
        scales: {
          ...
          x: {
            ...
            grid: {
                drawTicks: false,
                color: (context) => {
                  if (context.tick.label === '30') {
                    return darkMode ? textColor.dark : textColor.light;
                  }
                },
            },
      ...
      <div className="px-5 py-3">
        <div className="flex flex-wrap justify-between items-end gap-y-2 gap-x-4">
          <div className="flex items-start">
            <div className="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">$2 Million</div>
          </div>
        </div>
      </div>
      <div className="grow">
