...
export const FixedExpensesCard = () => {
  ...
  const chartData: ChartData = {
    ...
    datasets: [
      {
        label: 'Mortgage Payment (incl. PMI, Taxes, Insurance)',
        data: [4114],
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex items-center">
        <h2 className="font-semibold text-gray-800 dark:text-gray-100">Future Essentials</h2>
      </header>
      <div className="px-5 py-3">
        <div className="flex items-start">
          <div className="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">$4,714</div>
        </div>
      </div>      
      <div className="grow">
